...
BASE_DIR = Path(__file__).resolve().parent.parent # LẤY THƯ MỤC GỐC HIỆN TẠI , RESOLVE BỎ ĐI CÁC TIỂU TIỆC KHÔNG CẦN THIẾT , .PARENT TRẢ LẠI ĐƯỜNG DẪN THEO CHA ,....
#BASE_DIR = C:\Users\Trong Tin\Desktop\LMS-FSA-truong-dev
...
DATABASES = {
    'default': {
        ...
        'NAME': 'lms_fsa_truong_2',  # Tên cơ sở dữ liệu mà bạn đã tạo
...
#session
SESSION_ENGINE = 'django.contrib.sessions.backends.db'  # Sử dụng session trong database
SESSION_COOKIE_NAME = 'sessionid'  # Tên cookie cho session
